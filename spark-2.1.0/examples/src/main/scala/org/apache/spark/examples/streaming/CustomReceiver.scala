...
//
    val spark = SparkSession.builder().appName("streaming-demo").getOrCreate()
    val lines = spark.readStream.format("socket")
      .option("host", "10.13.2.197").option("port", 9999).load()
...
class CustomReceivers(host: String, port: Int)
